...
class ProbandoDebito(object):
    ...
    def sign_xml(self, fichero_xml):
        ...
        name = fichero_xml
        vars = self.rsa_sign(xml=fichero_xml,ref_uri="", private_key=key_file, password="SFSC42")
        ...
        firma = firma.replace('<ds:SignedInfo xmlns="urn:oasis:names:specification:ubl:schema:xsd:DebitNote-2" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:ccts="urn:un:unece:uncefact:documentation:2" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:ext="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2" xmlns:qdt="urn:oasis:names:specification:ubl:schema:xsd:QualifiedDatatypes-2" xmlns:sac="urn:sunat:names:specification:ubl:peru:schema:xsd:SunatAggregateComponents-1" xmlns:udt="urn:un:unece:uncefact:data:specification:UnqualifiedDataTypesSchemaModule:2" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">','<ds:SignedInfo xmlns:ds="http://www.w3.org/2000/09/xmldsig#">')
        ...
        # reflist = xmldoc.getElementsByTagName('ext:ExtensionContent')
        # tgexte = reflist[1].toxml()
        # print tgexte
        # a = root.find('<ext:ExtensionContent>').tag
        # tree = etree.SubElement(a, factura)
        ...
        # r = Probando()
# r.sign_xml(fichero_xml='d:/20495932797-07-F001-00000008.xml')