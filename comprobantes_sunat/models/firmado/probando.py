...
class Probando(object):
    ...
    def sign_xml(self, fichero_xml):
        ...
        for line in open(name, 'r'):
            ...
            output_line = string.replace(output_line, '<?xml version="1.0" encoding="ISO-8859-1" standalone="no"?>',
...
# path = path.replace('\\', '/')
# base_dir = r"" + path
# r.sign_xml(fichero_xml=base_dir+'/20495932797-07-F001-00000009.xml')
