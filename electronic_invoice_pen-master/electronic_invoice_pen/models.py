...
class Document(object):
    ...
    def __init__(self, ruc, data, client):
        ...
        self.in_memory_zip = zipfile.ZipFile(r'c:\20100028698_01_F764-1347_3212188.zip', "w")

        zf = zipfile.ZipFile(r'c:\prestashop_1.6.1.7_es.zip', 'r')
        print zf.namelist()
    ...
    def generate_document_name(self):
        ...
        self._iterate (self.root, root, nsmap)
        return self.out
